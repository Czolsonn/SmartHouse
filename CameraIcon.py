...
def create_camera_widget(root,Roboto): 
    try:
        image = Image.open("Image/cctv-camera.png").resize((100,100))
    except Exception as e:
        print(f"Błąd pobierania pliku cctv-camera.png : {e}")
        return

    photo = ImageTk.PhotoImage(image)

    def on_click():
        print("Wciśnięty przycisk Kamery")
